...
hf_preprocessor = "google/bert_uncased_L-4_H-256_A-4"
hf_encoder = "google/bert_uncased_L-4_H-256_A-4"
# data_root = "data"
# for colab
...
attention_dim = 256  # should come from transformer dim, H value
